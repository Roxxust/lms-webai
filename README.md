lm studio web server example to show how to connect lm studio to a local webserver through cors using rust, currently/previously lm studio requires a reverse proxy for implementation.  
